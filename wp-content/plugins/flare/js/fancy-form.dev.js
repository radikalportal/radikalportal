...
(function($){
    ...
    FancyForm.prototype.fancySelect = function($elem){
        ...
        $wrapper.width($elem.outerWidth())
                .bind('click', function(event){
                    self.hideOptions();
                    $wrapper.addClass('fancy-select-open');
        ...
        $selected.text($selectedOption.text()).attr('data-value', $selectedOption.val());
    ...
    FancyForm.prototype.showOptions = function($elem){
        var self = this;
        var $options = $elem.find('option'),
            $fancySelect = $elem.closest('.fancy-select');
            ...
            this.dropdown.delegate('.option', 'click', function(){
                ...
                $options.each(function(i){
                    ...
                    if(this.selected == true)
                        $select.siblings('.selected').text(this.text).attr('data-value', this.value);
                });
        ...
        // Cleanup from previous opens
        $fancySelect.removeClass('invert');
        this.dropdown.removeAttr('for');
        
        if($elem.attr('id') != ""){
            this.dropdown.attr('for', $elem.attr('id'));
        }
    ...
    FancyForm.prototype.hideOptions = function(){
        $('.fancy-select-open').removeClass('fancy-select-open');
